...
#ifndef HAS_PSRAM
  // `weak` lets this header-defined global be included in multiple translation
  // units without a duplicate-symbol link error on modern GCC (-fno-common /
  // strong initialised definitions). Single shared instance, behaviour unchanged.
  char index_html[MAX_HTML_SIZE] __attribute__((weak)) = "TEST";
#else
